...
[PresionArterial])
VALUES (1, 'Popstar', 'Potata', '1990-10-10', 'San Pedro', 1.5,
50.1, NULL),
 (2, 'Arven', 'Arijas', '1980-10-11', 'Heredia', 1.7, 70,
80),
 (3, 'Andrea', 'Ledezma', '1997-09-19', 'Santa Ana', 1.7, 80,
NULL);
SET IDENTITY_INSERT dbo.[Paciente] OFF
SET IDENTITY_INSERT dbo.[Medico] ON
INSERT INTO dbo.[Medico]([Id], [Nombre], [Apellidos],
[Especialidad], [Oficina])
VALUES (1, 'Andrea', 'Salas', 'Otorino', 111),
(2, 'Steriel', 'Guzman', 'General', 101),
 (3, 'Adrían', 'Ramires', 'General', 100);
SET IDENTITY_INSERT dbo.[Medico] OFF
INSERT INTO dbo.[Consulta]([IdPaciente], [IdMedico], [Fecha],
